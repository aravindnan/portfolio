export const PersonalInformation = {
  ...
  personalDescription: `Results-driven and forward-thinking IT professional with a proven track record in multimedia manipulation, interactive programming.Continually exploring innovative programming methodologies and new desing trends in user experience.
...
export const WorkExperience = [
  {
    ...
    workLink:
      "https://drive.google.com/drive/folders/1mJQsOP_QoKO1hqUP4K2Z3myAYSOf9lNW?usp=share_link",
  ...
  },
  {
    ...
    workLink:
      "https://drive.google.com/drive/folders/1qMhCAWZmnCeiYf4WyjSM9YheERCS4ODK?usp=share_link",
    RRs: [
...
export const Projects = [
  {
    ...
    projectLink: "https://github.com/aravind2347214/Specialization-Project",
    projectFeatures: [
      "OCR-based data extraction from PDF records for liver cirrhosis parameters.",
      "MRI image analysis for liver disease classification.",
      "Machine learning classifier for liver cirrhosis stage prediction.",
      "Integration with Gemini API for generating suggestions and recommendations.",
      "Cloudinary integration for storing images and PDFs.",
      "User authentication and secure access to results.",
      "Data storage and management using MongoDB for both PDF and MRI results.",
    ],
  },

  {
    projID: "p6",
    projectName: "Team Management Software",
    projectMedium: ["React JS", "Tailwind CSS", "Mongo DB", "Node JS", "Express"],
    projectLink: "https://github.com/aravind2347214/TeamManagementSoftware",
    projectFeatures: [
      "User Authentication for login and registration with validation",
      "Project dashboard displaying assigned projects and their summaries",
      "Task management system allowing task creation, assignment, and status updates",
      "Real-time commenting on tasks and notifications for task updates",
      "File upload and sharing functionality for project-related documents",
      "Role-based access control to manage permissions for project members",
...

  {
    ...
    projectLink:
      "https://drive.google.com/drive/folders/1_F1oqSr-F3m-POaJlu8XbJIuswPkDZPl?usp=share_link",
    projectFeatures: [
      "Created a UI design and UX workflow.",
  ...
  //  {projID:"p5",
  //  projectName:"Car Dealership Project",
  //  projectMedium:["Figma","React","NodeJS","MySQL","WampServer"],
  //  projectLink:"https://github.com/aravind2347214/car-dealership-project",
  //  projectFeatures:[
  //    "Worked with other members",
  //    "Created a UI design and UX workflow.",
  //    "Sample Project Made for Academic Purpose",
  //    "Helps users see and compare cars side by side",
  //    "Form values taken to Mysql database",
  //    "Admin dash board to perform CURD operations",
  //  ]},

  {
    projID: "p1",
    projectName: "Car Dealership",
    projectMedium: ["NodeJS", "React JS", "MySQL","Wamp Server","Tailwind CSS"],
    projectLink: "https://github.com/aravindnan/portfolio",
    projectFeatures: [
      "Created a UI design and UX workflow.",
      "Sample Project Made for Academic Purpose",
      "Helps users see and compare cars side by side",
