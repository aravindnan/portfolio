...
function PersonalInfoBlock() {
  return (
    ...
    <div data-aos="fade-in" data-aos-once={true} className=" md:text-[20px] lg:text-[30px] font-semibold">Computer Science Graduate</div>
    ...
    proven track record in multimedia manipulation, interactive
     programming.Continually exploring innovative programming methodologies and new desing
