...
function SingleIntrestComponent(props) {
    const{data}=props;
  return (
    <div data-aos="zoom-in" data-aos-once={true} data-aos-anchor-placement="bottom" className=' flex h-[60px] w-[60px] flex-col my-1 border-transparent border-[1px] p-2 rounded-[0px] justify-center  mx-1 '>
